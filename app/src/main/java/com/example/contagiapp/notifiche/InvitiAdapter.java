...
public class InvitiAdapter extends RecyclerView.Adapter<com.example.contagiapp.notifiche.InvitiAdapter.ViewHolder>{
    ...
    @Override
    public void onBindViewHolder(@NonNull com.example.contagiapp.notifiche.InvitiAdapter.ViewHolder holder, int position) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        com.example.contagiapp.notifiche.InvitiAdapter.OnUserListener onUserListener;
